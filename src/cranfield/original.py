"""Generate original document + query embeddings for Cranfield."""
...
print()
with open("../../cranfield/data/original_embeddings.json", "w") as f:
...
with open("../../cranfield/data/query_embeddings.json", "w") as f:
